 ...
 * @author Shai Almog
 */
public class NotificationDemoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "NotificationDemo";
    ...
    private NotificationDemo mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new NotificationDemoStub());
    }
